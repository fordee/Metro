...
let availableRoutes: [Route] = [
  Route(routeId: 190, agencyId: "TZM", routeShortName: "19", routeLongName: "Johnsonville - Churton Park - Johnsonville", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 230, agencyId: "TZM", routeShortName: "23", routeLongName: "Houghton Bay - Newtown - Vogeltown - Kingston", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 1500, agencyId: "TZM", routeShortName: "150", routeLongName: "Kelson - Lower Hutt - Maungaraki - Petone", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 1540, agencyId: "TZM", routeShortName: "154", routeLongName: "Petone - Korokoro - Petone", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 181, agencyId: "NBM", routeShortName: "18e", routeLongName: "Miramar - Newtown - Kelburn - Karori", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 2600, agencyId: "UZM", routeShortName: "260", routeLongName: "Raumati Beach - Paraparaumu Beach - Paraparaumu", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 290, agencyId: "TZM", routeShortName: "29", routeLongName: "Newtown - Southgate - Owhiro Bay - Brooklyn", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 180, agencyId: "NBM", routeShortName: "18", routeLongName: "Miramar - Kilbirnie", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 220, agencyId: "NBM", routeShortName: "22", routeLongName: "Johnsonville - Mairangi - Kelburn - Wellington", routeType:   3, routeColor: "f58025", routeTextColor: "0"),
  ...
  Route(routeId: 1110, agencyId: "TZM", routeShortName: "111", routeLongName: "Upper Hutt - Totara Park - Upper Hutt", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 2300, agencyId: "TZM", routeShortName: "230", routeLongName: "Whitby Route(The Crowsnest), - Aotea - Porirua", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 140, agencyId: "NBM", routeShortName: "14", routeLongName: "Wilton - Wellington - Roseneath - Hataitai - Kilbirnie", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 2610, agencyId: "UZM", routeShortName: "261", routeLongName: "Paraparaumu Beach - Paraparaumu Route(via Guildford Drive),", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 830, agencyId: "NBM", routeShortName: "83", routeLongName: "Eastbourne - Lower Hutt - Petone - Wellington", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 2200, agencyId: "TZM", routeShortName: "220", routeLongName: "Titahi Bay - Porirua - Ascot Park", routeType:   3, routeColor: "8854", routeTextColor: "0"),
  Route(routeId: 30, agencyId: "NBM", routeShortName: "3", routeLongName: "Lyall Bay/Rongotai - Kilbirnie - Newtown - Wellington", routeType:   3, routeColor: "5e9732", routeTextColor: "0"),
  Route(routeId: 2100, agencyId: "TZM", routeShortName: "210", routeLongName: "Titahi Bay - Porirua", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 240, agencyId: "TZM", routeShortName: "24", routeLongName: "Johnsonville - Broadmeadows - Wellington - Miramar Heights", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 2810, agencyId: "UZM", routeShortName: "281", routeLongName: "Waikanae - Waikanae East - Waikanae", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 8, agencyId: "EBYW", routeShortName: "WHF", routeLongName: "Wellington Harbour Ferry Route(Days Bay - Queens Wharf),", routeType:   4, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 2500, agencyId: "UZM", routeShortName: "250", routeLongName: "Paraparaumu - Raumati South - Paraparaumu", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 4, agencyId: "RAIL", routeShortName: "WRL", routeLongName: "Wairarapa Line Route(Masterton - Wellington),", routeType:   2, routeColor: "ffc000", routeTextColor: "0"),
  ...
  Route(routeId: 120, agencyId: "NBM", routeShortName: "12", routeLongName: "Strathmore Park - Kilbirnie - Newtown", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 1200, agencyId: "TZM", routeShortName: "120", routeLongName: "Stokes Valley - Taita - Epuni - Lower Hutt", routeType:   3, routeColor: "8854", routeTextColor: "0"),
  ...
  Route(routeId: 1210, agencyId: "TZM", routeShortName: "121", routeLongName: "Stokes Valley Heights - Naenae - Lower Hutt - Seaview", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 600, agencyId: "MNM", routeShortName: "60", routeLongName: "Porirua - Tawa - Johnsonville", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 5, agencyId: "RAIL", routeShortName: "HVL", routeLongName: "Hutt Valley Line Route(Upper Hutt - Wellington),", routeType:   2, routeColor: "ff6600", routeTextColor: "0"),
  ...
  Route(routeId: 210, agencyId: "NBM", routeShortName: "21", routeLongName: "Karori Route(Wrights Hill), - Kelburn - Courtenay Place", routeType:   3, routeColor: "ee80b3", routeTextColor: "0"),
  ...
  Route(routeId: 1450, agencyId: "TZM", routeShortName: "145", routeLongName: "Belmont - Melling - Lower Hutt", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 250, agencyId: "TZM", routeShortName: "25", routeLongName: "Khandallah - Wellington - Aro Valley - Highbury", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 1600, agencyId: "TZM", routeShortName: "160", routeLongName: "Wainuiomata North - Waterloo - Lower Hutt", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 170, agencyId: "TZM", routeShortName: "17", routeLongName: "Kowhai Park - Brooklyn", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 1700, agencyId: "TZM", routeShortName: "170", routeLongName: "Lower Hutt - Wainuiomata South - Lower Hutt", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 2800, agencyId: "UZM", routeShortName: "280", routeLongName: "Waikanae - Waikanae Beach - Waikanae", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 1140, agencyId: "TZM", routeShortName: "114", routeLongName: "Trentham - Elderslea - Upper Hutt", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 1120, agencyId: "TZM", routeShortName: "112", routeLongName: "Te Marua - Timberlea - Maoribank - Upper Hutt", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 2620, agencyId: "UZM", routeShortName: "262", routeLongName: "Paraparaumu Beach - Paraparaumu Route(via Mazengarb Road),", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 1150, agencyId: "TZM", routeShortName: "115", routeLongName: "Upper Hutt - Pinehaven - Upper Hutt", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 2360, agencyId: "TZM", routeShortName: "236", routeLongName: "Whitby Route(Navigation Drive), - Paremata - Papakowhai - Porirua", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 3, agencyId: "RAIL", routeShortName: "MEL", routeLongName: "Melling Line Route(Melling - Wellington),", routeType:   2, routeColor: "ff6600", routeTextColor: "0"),
  Route(routeId: 200, agencyId: "NBM", routeShortName: "20", routeLongName: "Kilbirnie - Mt Victoria - Courtenay Place", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 6, agencyId: "RAIL", routeShortName: "JVL", routeLongName: "Johnsonville Line Route(Johnsonville - Wellington),", routeType:   2, routeColor: "42c3dc", routeTextColor: "0"),
  ...
  Route(routeId: 2000, agencyId: "TZM", routeShortName: "200", routeLongName: "Masterton - Greytown - Featherston - Martinborough", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  Route(routeId: 2900, agencyId: "UZM", routeShortName: "290", routeLongName: "Waikanae - Otaki - Waikanae", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
  ...
  Route(routeId: 2, agencyId: "RAIL", routeShortName: "KPL", routeLongName: "Kapiti Line Route(Waikanae - Wellington),", routeType:   2, routeColor: "d4e031", routeTextColor: "0"),
  ...
  Route(routeId: 2260, agencyId: "TZM", routeShortName: "226", routeLongName: "Sievers Grove - Elsdon - Sievers Grove", routeType:   3, routeColor: "6cace4", routeTextColor: "0"),
